<!--
201-BRIEF.md — written by the IC from icc-situation-analyst findings, once,
at the stem (/icc-new). Never edited after typing is confirmed except to
...
<!-- One bullet per analyst finding, each citing its source. Pull directly
     from the icc-situation-analyst structured returns (schemas.md #1) --
...
<!-- Files/subsystems believed affected. The Planning Chief will refine
     this into an actual territory partition during /icc-plan -- this is
...
## Intake source (for /icc-close to route back to)
