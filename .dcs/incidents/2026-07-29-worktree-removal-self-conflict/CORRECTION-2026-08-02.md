...
Corrects the artifact record of incident `worktree-removal-self-conflict` (`.dcs/incidents/2026-07-29-worktree-removal-self-conflict/`); issued by incident `record-integrity-corrections`.
...
```
git log --all --full-history -- ".dcs/incidents/2026-07-29-worktree-removal-self-conflict/201-BRIEF.md"
```
(no output)

```
git log --all --full-history -- ".dcs/incidents/2026-07-29-worktree-removal-self-conflict/202-OBJECTIVES.md"
```
(no output)

```
git log --all --full-history -- ".dcs/incidents/2026-07-29-worktree-removal-self-conflict/203-ORG.md"
```
(no output)

```
git log --all --full-history -- ".dcs/incidents/2026-07-29-worktree-removal-self-conflict/204-TASKING/"
```
(no output)

```
git log --all --full-history -- ".dcs/incidents/2026-07-29-worktree-removal-self-conflict/IAP.md"
```
(no output)

```
git log --all --full-history -- ".dcs/incidents/2026-07-29-worktree-removal-self-conflict/214-LOG.md"
```
(no output)
...
```
git log --all --full-history --pretty=format: --name-only -- "*2026-07-29-worktree-removal-self-conflict*" | sort -u
```
Output:
```
