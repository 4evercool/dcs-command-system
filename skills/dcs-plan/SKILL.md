---
name: dcs-plan
description: "DCS planning arc: objectives (202) → chiefs' tactics → integrated IAP → Owner approval (hash-stamped). Use when an active DCS incident needs its operational-period plan."
argument-hint: "[notes]"
allowed-tools:
  - Read
  - Write
