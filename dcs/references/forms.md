...
| `203-ORG.md` | IC | `/dcs-plan`, after chief(s) return | Which positions are activated this period (Planning Chief only? + Logistics Chief? how many specialists?) |
...
| `.dcs/esg/REGISTER.md` | Chief of Staff (CoS) | `/dcs-esg`, and touched by `/dcs-new`, `/dcs-plan`, `/dcs-close` | Incident portfolio: QUEUED / ACTIVE / PARKED / CLOSED table |
